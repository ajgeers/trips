...
// Prevents overshooting and loops by using distance-based parameterization
function createCurvedLine(points, alpha = 1.0) {
    ...
    for (let i = 0; i < points.length - 1; i++) {
        ...
        for (let step = 0; step <= steps; step++) {
            ...
            // Catmull-Rom interpolation with centripetal parameterization
